...
def main(argv):
    ...
    ###subtraction of points
      ...
      l1, = ax1.plot(hlrmin_range,x1_DFT_1, 'b-', label='l1')
      l2, = ax1.plot(hlrmin_range,x1_Photon_1, 'g-', label='l2')
      l3, = ax1.plot(hlrmin_range,y,'r--',label='l3')
      plt.legend([l1,l2,l3],['DFT','Photon','Y=0'], loc='upper right')
      ax1.set_title('Gaussian PSF with Gaussian Galaxy Profile at flux=10')
      l4, = ax2.plot(hlrmin_range,xnew_1,'y-', label='l4')
      l5, = ax2.plot(hlrmin_range,y,'r--', label='l5')
      ...
      f, (ax1, ax2) = plt.subplots(2, sharex=True, sharey=True)
      l1, = ax1.plot(hlrmin_range,x1_DFT_2, 'b-', label='l1')
      l2, = ax1.plot(hlrmin_range,x1_Photon_2, 'g-', label='l2')
      l3, = ax1.plot(hlrmin_range,y,'r--', label='l3')
      plt.legend([l1,l2,l3],['DFT','Photon','Y=0'], loc='upper right')
      ax1.set_title('Gaussian PSF with Exponential Galaxy Profile at flux=')
      l4, = ax2.plot(hlrmin_range,xnew_2,'y-', label='l4')
      l5, = ax2.plot(hlrmin_range,y,'r--', label='l5')
      plt.legend([l4,l5],['DFT - Photon','Y=0'], loc='upper right')
      plt.xlabel('hlrmin')
      plt.ylabel('time')
      ...
      f, (ax1, ax2) = plt.subplots(2, sharex=True, sharey=True)
      l1, = ax1.plot(hlrmin_range,x1_DFT_3, 'b-', label='l1')
      l2, = ax1.plot(hlrmin_range,x1_Photon_3, 'g-', label='l2')
      l3, = ax1.plot(hlrmin_range,y,'r--', label='l3')
      plt.legend([l1,l2,l3],['DFT','Photon','Y=0'], loc='upper right')
      ax1.set_title('Gaussian PSF with Devaucouleurs Galaxy Profile at flux=')
      l4, = ax2.plot(hlrmin_range,xnew_3, 'y-', label='l4')
      l5, = ax2.plot(hlrmin_range,y,'r--', label='l5')
      plt.legend([l4,l5],['DFT - Photon','Y=0'], loc='upper right')
      plt.xlabel('hlrmin')
      plt.ylabel('time')
      ...
      f, (ax1, ax2) = plt.subplots(2, sharex=True, sharey=True)
      l1, = ax1.plot(hlrmin_range,x1_DFT_4, 'b-', label='l1')
      l2, = ax1.plot(hlrmin_range,x1_Photon_4, 'g-', label='l2')
      l3, = ax1.plot(hlrmin_range,y,'r--', label='l3')
      plt.legend([l1,l2,l3],['DFT','Photon','Y=0'], loc='upper right')
      ax1.set_title('Gaussian PSF with n=2.5 Sersic Galaxy Profile at flux=')
      l4, = ax2.plot(hlrmin_range,xnew_4, 'y-', label='l4')
      l5, = ax2.plot(hlrmin_range,y,'r--', label='l5')
      plt.legend([l4,l5],['DFT - Photon','Y=0'], loc='upper right')
      plt.xlabel('hlrmin')
      plt.ylabel('time')
      ...
      f, (ax1, ax2) = plt.subplots(2, sharex=True, sharey=True)
      l1, = ax1.plot(hlrmin_range,x1_DFT_5, 'b-', label='l1')
      l2, = ax1.plot(hlrmin_range,x1_Photon_5, 'g-', label='l2')
      l3, = ax1.plot(hlrmin_range,y,'r--', label='l3')
      plt.legend([l1,l2,l3],['DFT','Photon','Y=0'], loc='upper right')
      ax1.set_title('Gaussian PSF with Bulge + Disk Galaxy Profile at flux=')
      l4, = ax2.plot(hlrmin_range,xnew_5, 'y-', label='l4')
      l5, = ax2.plot(hlrmin_range,y,'r--', label='l5')
      plt.legend([l4,l5],['DFT - Photon','Y=0'], loc='upper right')
      plt.xlabel('hlrmin')
      plt.ylabel('time')
