...
def main(argv):
    ...
    scaleimg_x_DFT=[]
    scaleimg_x_Photon=[]
#    ranges = np.linspace(.1,1,5)
    ranges = np.linspace(.1,2,5)
    for num in ranges:
