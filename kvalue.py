...
def main(argv):
    ...
    scaleimg_x_DFT=[]
    scaleimg_x_Photon=[]
    ranges = np.linspace(1.e-7,1.e-1,5)
    for num in ranges:
...
### Define some parameters we'll use below.
    ...
    # off for speed or memory).  
        ...
        gsparams = galsim.GSParams(
            ...
            kvalue_accuracy=num,   # approximations in fourier space aim to be this accurate
