#does not have a cross-over flux
...
def main(argv):
    ...
    scaleimg_x_DFT=[]
    scaleimg_x_Photon=[]
    ranges = np.linspace(1.e1,1.e10,5)
    for num in ranges:
