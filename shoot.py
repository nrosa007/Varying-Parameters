...
def main(argv):
    ...
    scaleimg_x_DFT=[]
    scaleimg_x_Photon=[]
    ranges = np.linspace(1.e-6,1.e-1,5)
    for num in ranges:
...
### Define some parameters we'll use below.
    ...
    # off for speed or memory).  
        ...
        gsparams = galsim.GSParams(
            ...
            shoot_accuracy=num,    # approximations in photon shooting aim to be this accurate
...
###subtraction of points
    ...
    plt.savefig('shooting_accuracy_1.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('shooting_accuracy_2.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('shooting_accuracy_4.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('shooting_accuracy_5.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('shooting_accuracy_6.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('shooting_accuracy_7.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('shooting_accuracy_8.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('shooting_accuracy_9.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('shooting_accuracy_10.png')
