#this does have a cross-over flux
import sys
import os
import math
import numpy
...
### Define some parameters we'll use below.
    ...
    # off for speed or memory).  
        ...
        gsparams = galsim.GSParams(
            folding_threshold=num, # maximum fractional flux that may be folded around edge of FFT
...
###subtraction of points
  ...
  #### [FOR FIGURES 6-10] for the first PSF and 5 galaxy profile for all flux at 1020
    ...
    plt.savefig('folding_threshold_1.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('folding_threshold_2.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('folding_threshold_3.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('folding_threshold_4.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('folding_threshold_5.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('folding_threshold_6.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('folding_threshold_7.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('folding_threshold_8.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('folding_threshold_9.png')
    ...
    f.subplots_adjust(hspace=0)
    plt.setp([a.get_xticklabels() for a in f.axes[:-1]], visible=False)
    plt.savefig('folding_threshold_10.png')
